...
RULES = [
    ...
    # 상호명, 플랫폼명
    # ===========================
    {"pattern": r"(?:NAVER|Naver|naver|네이버|Daum|daum|다음|Kakao|kakao|카카오|\bGoogle\b(?!\s?(Docs|Classroom|TV|Maps))|google(?!\s?(docs|classroom|tv|maps))|구글(?!\s?(독스|클래스룸|티비|맵)))", "label": "상호명", "replacement": "포털사이트", "confidence": 0.95, "source": {"doc": "대체표현", "page": 1, "quote": "Google(구글), NAVER(네이버), Daum(다음), Kakao(카카오) 등 → 포털사이트"}, "aliases": ["googel", "gooogle", "구글검색", "네이버검색", "다음검색", "카카오검색", "네이벌", "구굴", "네이바"]},
    ...
    {"pattern": r"(?:YouTube|유튜브|TVING|티빙|watcha|왓챠|netflix|넷플릭스|wavve|웨이브|disney\s?plus|디즈니\+?|디즈니플러스|OTT)", "label": "상호명", "replacement": "동영상 플랫폼", "confidence": 0.95, "source": {"doc": "대체표현", "page": 1, "quote": "YouTube(유튜브), TVING(티빙) ... OTT 등 → 동영상 플랫폼"}, "aliases": ["yutube", "you tube", "유튭", "유툽", "넷플", "왓챠플레이", "유튜브쇼츠", "쇼츠", "shorts", "유튜브영상"]},
    ...
    {"pattern": r"(?:KakaoTalk|카카오톡|카톡|\bLINE\b|(?<![가-힣])라인(?![가-힣])|Instagram|인스타그램|Twitter|트위터|Meta|메타|Facebook|페이스북)", "label": "상호명", "replacement": "소셜 네트워크 서비스", "confidence": 0.95, "source": {"doc": "대체표현", "page": 1, "quote": "KakaoTalk, Instagram, Facebook 등 → 메신저, 소셜네트워크서비스"}, "aliases": ["kakaotalk", "kkt", "카톡방", "인스타", "insta", "페북", "x(트위터)", "인스타릴스", "릴스", "인스타그램릴스"]},
    {"pattern": r"(?:Chat\s?GPT|챗\s?GPT|챗지피티|wrtn|뤼튼|bing\s?Chat|빙챗|Bard|바드|하이퍼클로바X|HyperClova\s?X|Gemini|제미나이|Claude|클로드)", "label": "상호명", "replacement": "생성형 인공지능", "confidence": 0.95, "source": {"doc": "대체표현", "page": 1, "quote": "Chat GPT(챗지피티), wrtn(뤼튼) ... 등 → 대화형 인공지능, 생성형 인공지능"}, "aliases": ["chatgpt", "챗쥐피티", "gpt챗", "빙챗봇", "하클x", "뤼튼ai", "지피티", "GPT", "쳇지피티", "gemini ai"]},
    ...
    # 개발 언어 / 개발 도구
    # ===========================
    {"pattern": r"(?:Python|파이썬|Java(?!Script)(?!\s*Script)\b|자바(?!스크립트)|C\+\+|C언어|자바\s?언어|자바\s?스크립트|Java\s*Script|JavaScript|Javascript|(?<![A-Za-z])JS(?![A-Za-z]))", "label": "프로그램명", "replacement": "프로그래밍 언어", "confidence": 0.92, "source": {"doc": "대체표현", "page": 2, "quote": "프로그램명 (파이썬, C언어 등) 기재 불가"}, "aliases": ["파이선", "자바스크립", "씨언어", "javascript", "java script", "js", "파이톤", "자바언어"]},
    ...
    # [신규] 음원 스트리밍 플랫폼
    # ===========================
    {"pattern": r"(?:Spotify|스포티파이|Melon|멜론|Genie|지니뮤직|Bugs|벅스뮤직|Apple\s?Music|애플\s?뮤직|FLO|플로)", "label": "상호명", "replacement": "음원 스트리밍 서비스", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 음원 플랫폼명은 일반화 표현 사용"}, "aliases": ["스포티파이앱", "멜론차트", "지니차트", "벅스차트", "애플뮤직", "플로앱"]},

    # ===========================
    # [신규] 전자상거래 플랫폼
    # ===========================
    {"pattern": r"(?:Coupang|쿠팡|11번가|G마켓|지마켓|SSG|쓱닷컴|옥션|Auction|위메프|TMON|티몬)", "label": "상호명", "replacement": "온라인 쇼핑 플랫폼", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 쇼핑 플랫폼명은 일반화 표현 사용"}, "aliases": ["쿠팡이츠", "로켓배송", "쓱배송"]},
    ...
    # [신규] 협업 메신저
    # ===========================
    {"pattern": r"(?:Discord|디스코드|Slack|슬랙|Microsoft\s?Teams|팀즈|Teams)", "label": "상호명", "replacement": "협업 메신저", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 메신저명은 일반화 표현 사용"}, "aliases": ["디코", "디스코드서버", "슬랙채널", "팀즈회의"]},
    ...
    # [신규] 웹 브라우저
    # ===========================
    {"pattern": r"(?:Chrome|크롬|Safari|사파리|Edge|엣지|Whale|웨일|Firefox|파이어폭스)(?:\s?브라우저)?", "label": "상호명", "replacement": "웹 브라우저", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 브라우저명은 일반화 표현 사용"}, "aliases": ["크롬브라우저", "사파리브라우저", "웨일브라우저"]},
    ...
    # [신규] 전자책/독서 플랫폼
    # ===========================
    {"pattern": r"(?:Kindle|킨들|밀리의\s?서재|리디북스|RIDI|리디|YES24)", "label": "상호명", "replacement": "전자책 플랫폼", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 전자책 플랫폼명은 일반화 표현 사용"}, "aliases": ["킨들앱", "밀리서재"]},
    ...
    {"pattern": r"(?:SQLD|SQLP|에스큐엘디|에스큐엘피)", "label": "자격시험", "replacement": "", "confidence": 0.99, "source": {"doc": "자격시험 기재불가", "page": 1, "quote": "민간자격시험 성적 기재 불가"}, "aliases": [], "delete_with_particle": True},
    {"pattern": r"(?:CPA|공인회계사|CFA)", "label": "자격시험", "replacement": "", "confidence": 0.99, "source": {"doc": "자격시험 기재불가", "page": 1, "quote": "전문자격시험 성적 기재 불가"}, "aliases": [], "delete_with_particle": True},
    ...
    # [신규] 수학/과학 도구
    # ===========================
    {"pattern": r"(?:GeoGebra|지오지브라|Desmos|데스모스|Wolfram\s?Alpha|울프람알파|MATLAB|매트랩)", "label": "프로그램명", "replacement": "수학 계산 도구", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 수학/과학 도구명은 일반화 표현 사용"}, "aliases": ["지오지브라앱", "데스모스앱"]},

    # ===========================
    # [신규] MS Office 제품군
    # ===========================
    {"pattern": r"(?:PowerPoint|파워포인트|PPT|피피티|Excel|엑셀|한글과컴퓨터|한컴|HWP|아래아한글)", "label": "프로그램명", "replacement": "문서작성 프로그램", "confidence": 0.92, "source": {"doc": "대체표현", "page": 1, "quote": "특정 오피스 프로그램명은 일반화 표현 사용"}, "aliases": ["파포", "피피티파일", "엑셀파일", "한글파일", "hwp파일"]},
